...
public class BlogPostDAO {
    ...
    public Document findByPermalink(String permalink) {
        ...
        post = new Document("permalink", permalink);

        FindIterable<Document> iterate = postsCollection.find(post);
        post = iterate.first();
    ...
    public void addPostComment(final String name, final String email, final String body,
    	...
    	Document newDoc = new Document("author", name).append("body", body);
    	if(email != null) newDoc.append("email", email);
    	
    	Bson update = Updates.push("comments", newDoc);
